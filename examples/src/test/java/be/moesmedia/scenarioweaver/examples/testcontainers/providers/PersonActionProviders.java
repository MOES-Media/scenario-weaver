...
@TestConfiguration
public class PersonActionProviders {

    @Bean
    ActionProvider<Person, PersonScenarioContext> createPersonAction(TestRestTemplate testRestTemplate) {
        return (payload, ctx) -> ctx.response(testRestTemplate.postForEntity("/person", payload, Person.class));
    }
}
